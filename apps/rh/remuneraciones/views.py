...
@login_required
def Rproduccion(request):
    context = {
        'mainModuleName': 'Recursos Humanos',
        'modulos': [
            {'parentModuleName': 'Remuneraciones'},
            {'childModuleName': 'Departamento Producción'}  
        ],
    ...
    # Page from the theme
    return render(request, 'pages/rh/remuneraciones/departamentos/produccion.html', context=context)
@login_required
def Rcrm(request):
    context = {
        'mainModuleName': 'Recursos Humanos',
        'modulos': [
            {'parentModuleName': 'Remuneraciones'},
            {'childModuleName': 'Departamento CRM'}  
        ],
        #'defaultUrl': 'menucapacitaciones',
        #'defaultChildUrl': 'rhGestionarCapacitaciones',
    }
    ...
    # Page from the theme
    return render(request, 'pages/rh/remuneraciones/departamentos/crm.html', context=context)
@login_required
def Radmin(request):
    context = {
        'mainModuleName': 'Recursos Humanos',
        'modulos': [
            {'parentModuleName': 'Remuneraciones'},
            {'childModuleName': 'Departamento Administración'}  
        ],
        #'defaultUrl': 'menucapacitaciones',
        #'defaultChildUrl': 'rhGestionarCapacitaciones',
    }
    ...
    # Page from the theme
    return render(request, 'pages/rh/remuneraciones/departamentos/administracion.html', context=context)
@login_required
def Rrrhh(request):
    context = {
        'mainModuleName': 'Recursos Humanos',
        'modulos': [
            {'parentModuleName': 'Remuneraciones'},
            {'childModuleName': 'Departamento Recursos Humanos'}  
        ],
        #'defaultUrl': 'menucapacitaciones',
        #'defaultChildUrl': 'rhGestionarCapacitaciones',
    }
    ...
    # Page from the theme
    return render(request, 'pages/rh/remuneraciones/departamentos/rrhh.html', context=context)
@login_required
def Rfinanzas(request):
    context = {
        'mainModuleName': 'Recursos Humanos',
        'modulos': [
            {'parentModuleName': 'Remuneraciones'},
            {'childModuleName': 'Departamento Finanzas'}  
        ],
        #'defaultUrl': 'menucapacitaciones',
        #'defaultChildUrl': 'rhGestionarCapacitaciones',
    }
    ...
    # Page from the theme
    return render(request, 'pages/rh/remuneraciones/departamentos/finanzas.html', context=context)
@login_required
